...
import tender.example.tender.service.ProjectTermsService;
...
@RequestMapping("api/v1/project_terms")
public class ProjectTermsController {

    private final ProjectTermsService service;
    ...
    @PostMapping("/create")
    public ResponseEntity<Object> create(@Valid @RequestBody ProjectTermsRequest request){
        try{
    ...
    @PutMapping("/update")
    public ResponseEntity<Object> update(@Valid @RequestBody ProjectTermsRequest request){
        try{
