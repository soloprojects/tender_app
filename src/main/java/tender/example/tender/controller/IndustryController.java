...
public class IndustryController {
    ...
    @PostMapping("/create")
    public ResponseEntity<Object> create(@Valid @RequestBody IndustryRequest request){
        try{
    ...
    @PutMapping("/update")
    public ResponseEntity<Object> update(@Valid @RequestBody IndustryRequest request){
        try{
